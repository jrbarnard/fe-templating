...
server_swap           = "1536" # Options: false | int (MB) - Guideline: Between one or two times the server_memory
...
public_folder         = "/var/www/fe-templating"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder ".", "/var/www/fe-templating",
    id: "core",
    :nfs => true,
